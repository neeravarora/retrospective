          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
				  ...
				  <li class="sub-menu">
                      ...
                      <ul class="sub">                      
                          <li><a class="" href="#" onclick="CurrentIterationWhatWentWell()">WhatWentWell</a></li>
                          <li><a class="" href="CurrentIterationWhatWentWell.jsp">WhatCouldHaveBeenBetter</a></li>
                          <li><a class="" href="CurrentIterationWhatWentWell.jsp">WhatDidNotGoWell</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
